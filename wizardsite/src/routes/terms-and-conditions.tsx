    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-8 py-12 sm:py-16">
        <div className="max-w-[720px] mx-auto">
          <p className="text-sm text-gray-500 font-semibold mb-2">(A2P Compliant Mobile Messaging Terms)</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            ...
            <div className="flex gap-6 flex-wrap">
              ...
              <Link to="/terms-and-conditions" className="text-sm text-gray-900 font-semibold">Terms & Conditions</Link>
